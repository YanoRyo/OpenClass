...
$(function () {
  $('.mgmtList__main__list--child').each(function () {
    ...
    var spons = spins.split(','); //console.log(spons);
...
$(function () {
  ...
  $('.actionBtn__btn--edit').on('click', function (e) {
    ...
    e.stopPropagation(); //filterAction
  ...
  $('.updateForm__submit--btn--cancel').on('click', function () {
    $('.updateForm').removeClass('active'); //filterAction
  ...
  $('.mainHead__opt--add--newaddition').on('click', function () {
    ...
    $('.filterMW').removeClass('filterMW__main--active');
    $('.mainHead__opt--filter').find('.filter-logo-img').removeClass('filter-logo-img-active'); //filterAction

    $('.mainHead__opt--filter').css('pointer-events', 'none');
  }); //management new addition form click-state

  $('.addNewForm__submit--btn--cancel').on('click', function () {
    $('.addNewForm').removeClass('active'); //filterAction
...
/***/ 2:
/*!*******************************************************!*\
  !*** multi ./resources/js/assets/organization/org.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/ec2-user/environment/openclass/resources/js/assets/organization/org.js */"./resources/js/assets/organization/org.js");
