...
Route::group([ 'middleware' => 'auth'], function () {
	...
	Route::post('/V2category/destroy','CategoryController@categories_destroy');
	...
	// Route::post('/import', 'TeacherController@import')->name('V2teacher');
	...
	Route::post('/import', 'ClassController@import')->name('V2class');
	...
	Route::get('/V2searchClass','ClassController@search_class')->name('V2searchClass');
	Route::get('/V2searchTeacher','TeacherController@search_teacher')->name('V2searchTeacher');
	Route::get('/V2searchAll','ClassController@search_allclass')->name('V2searchAll');

	
});


Route::get('/V2studentsClass','StudentController@list_class')->name('V2studentsClass');
Route::get('/V2studentsClass_show/{id}','StudentController@show_class')->name('V2studentsClass_show');
Route::get('/V2studentsTeacher','StudentController@list_teacher')->name('V2studentsTeacher');
Route::get('/V2studentsTeacher_show/{id}','StudentController@show_teacher')->name('V2studentsTeacher_show');
