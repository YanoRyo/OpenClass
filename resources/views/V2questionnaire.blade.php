...
<div class="question-page">
  ...
  <div class="quesWrap">
    <!-- <div class="quesWrap__areaHeader">
      <div class="quesWrap__areaHeader__className">
        <span class="quesColor">Webデザイン演習</span>
      </div>
      <div class="quesWrap__areaHeader__profName">
        <span class="quesColor">栗谷幸助</span><span class="quesColor">先生</span>
      </div>
    </div>
    <div class="quesWrap__message">
      <span class="quesColor">
        授業お疲れ様でした〜！<br>
        ...
        <div class="quesWrap__ques--each">
          ...
          <div class="quesWrap__ques--each__block">
            <div class="quesWrap__ques--each__block--ques">
              <span>Webデザイン演習 の授業は将来役に立つと思いますか？</span>
            </div>
            <div class="quesWrap__ques--each__block--value">
              ...
              <input type="radio" name="q1" value="5" id="q1a5" >
            </div>
          </div>
        </div>
        <div class="quesWrap__ques--each">
          ...
          <div class="quesWrap__ques--each__block">
            ...
            <div class="quesWrap__ques--each__block--value">
              ...
              <input type="radio" name="q2" value="5" id="q2a5" >
            </div>
          </div>
        </div>
        <div class="quesWrap__ques--each">
          ...
          <div class="quesWrap__ques--each__block">
            ...
            <div class="quesWrap__ques--each__block--value">
              ...
              <input type="radio" name="q3" value="5" id="q3a5" >
            </div>
          </div>
        </div>
        <div class="quesWrap__ques--each">
        ...
        <div class="quesWrap__ques--each">
          ...
          <div class="quesWrap__ques--each__block">
            ...
            <div class="quesWrap__ques--each__block--value">
              ...
              <input type="radio" name="q5" value="5" id="q5a5" >
            </div>
          </div>
        </div>
        <div class="quesWrap__ques--each">
          ...
          <div class="quesWrap__ques--each__block">
            <div class="quesWrap__ques--each__block--ques">
              ...
              <input type="text" class="input-type1" placeholder="例：回線が悪い"><span>なところを直せば、</span><br>
              <input type="text" class="input-type1" placeholder="例：授業がもっとスムーズになる">と思う...。
            </div>
          </div>
        </div>
        <div class="quesWrap__ques--each">
          ...
          <div class="quesWrap__ques--each__block">
            <div class="quesWrap__ques--each__block--ques">
              <input type="text" placeholder="例：授業のスムーズさ"><span>は他の授業よりも最高！</span>
            </div>
          </div>
        </div>
        <div class="quesWrap__ques--each">
          ...
          <div class="quesWrap__ques--each__block">
            <div class="quesWrap__ques--each__block--ques">
              <span>何か厨先生にコメントがあれば！</span><br>
              <textarea class="input-type1" name="" id=""></textarea>
            </div>
          </div>
        </div>
