...
<div class="question-page">
  ...
  <div class="question__time">
    <div class="question__time--now">
      <span>now</span>
    </div>
    <div class="question__time--time">
      <span id="question__time--time--display"></span><span>s</span>
    </div>
  </div>
  ...
  <div class="quesWrap">
    ...
    <div class="quesWrap__top">
      ...
      <div class="quesWrap__top--info">
        <div class="quesWrap__top--info--img">
          @if(is_null($class->image))
          <img src="/images/users/Profile.png" alt="">
          @else
          <img src="{{ asset($class->image) }}" alt="">
          @endif
        </div>
        <div class="quesWrap__top--info--name">
          <div class="quesWrap__top--info--name--class">
          ...
          <div class="quesWrap__ques--each__block">
            ...
            <div class="quesWrap__ques--each__block--value">
              <div class="quesWrap__ques--each__block--value--val">
                <label for="q1a1" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value1">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style=" opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
                          ...
                          C87.563,452.578,77.5,462.656,65.047,462.656z"></path>
                        <path class="st0" d="M512,286.875c0-16.5-7.859-31.125-19.984-40.469c3.484-4.469,5.984-9.266,7.641-13.75
                          ...
                          C421.563,332.188,427.313,337.953,434.422,337.953z"></path>
                      </g>
                      </svg>
                  </div>
                </label>
                <label for="q1a2" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value2">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style=" opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
                          h71.125c13.438,0,24.313-10.891,24.313-24.297V222.516C119.75,209.078,108.875,198.203,95.438,198.203z M65.047,462.656
                ...
                <label for="q1a3" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value3">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style="opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
                          h71.125c13.438,0,24.313-10.891,24.313-24.297V222.516C119.75,209.078,108.875,198.203,95.438,198.203z M65.047,462.656
                ...
                <label for="q1a4" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value4">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style="opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
                          h71.125c13.438,0,24.313-10.891,24.313-24.297V222.516C119.75,209.078,108.875,198.203,95.438,198.203z M65.047,462.656
                ...
                <label for="q1a5" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value5">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style="opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
                          h71.125c13.438,0,24.313-10.891,24.313-24.297V222.516C119.75,209.078,108.875,198.203,95.438,198.203z M65.047,462.656
              ...
              <input type="radio" name="que_1" value="1" id="q1a1" >
              <input type="radio" name="que_1" value="2" id="q1a2" >
              <input type="radio" name="que_1" value="3" id="q1a3" >
              <input type="radio" name="que_1" value="4" id="q1a4" >
              <input type="radio" name="que_1" value="5" id="q1a5" >
            </div>
          </div>
        </div>
        <div class="quesWrap__ques--each">
          ...
          <div class="quesWrap__ques--each__block">
            ...
            <div class="quesWrap__ques--each__block--value">
              <div class="quesWrap__ques--each__block--value--val">
                <label for="q2a1" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value1">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style=" opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
                ...
                <label for="q2a2" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value2">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style=" opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
                ...
                <label for="q2a3" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value3">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style="opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
                ...
                <label for="q2a4" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value4">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style="opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
                ...
                <label for="q2a5" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value5">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style="opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
              ...
              <input type="radio" name="que_2" value="1" id="q2a1" >
              <input type="radio" name="que_2" value="2" id="q2a2" >
              <input type="radio" name="que_2" value="3" id="q2a3" >
              <input type="radio" name="que_2" value="4" id="q2a4" >
              <input type="radio" name="que_2" value="5" id="q2a5" >
            </div>
          </div>
        </div>
        <div class="quesWrap__ques--each">
          ...
          <div class="quesWrap__ques--each__block">
            ...
            <div class="quesWrap__ques--each__block--value">
              <div class="quesWrap__ques--each__block--value--val">
                <label for="q3a1" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value1">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style=" opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
                ...
                <label for="q3a2" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value2">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style=" opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
                ...
                <label for="q3a3" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value3">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style="opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
                ...
                <label for="q3a4" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value4">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style="opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
                ...
                <label for="q3a5" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value5">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style="opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
              ...
              <input type="radio" name="que_3" value="1" id="q3a1" >
              <input type="radio" name="que_3" value="2" id="q3a2" >
              <input type="radio" name="que_3" value="3" id="q3a3" >
              <input type="radio" name="que_3" value="4" id="q3a4" >
              <input type="radio" name="que_3" value="5" id="q3a5" >
            </div>
          </div>
        </div>
        <div class="quesWrap__ques--each">
          ...
          <div class="quesWrap__ques--each__block">
            ...
            <div class="quesWrap__ques--each__block--value">
              <div class="quesWrap__ques--each__block--value--val">
                <label for="q4a1" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value1">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style=" opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
                ...
                <label for="q4a2" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value2">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style=" opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
                ...
                <label for="q4a3" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value3">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style="opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
                ...
                <label for="q4a4" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value4">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style="opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
                ...
                <label for="q4a5" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value5">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style="opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
              ...
              <input type="radio" name="que_4" value="1" id="q4a1" >
              <input type="radio" name="que_4" value="2" id="q4a2" >
              <input type="radio" name="que_4" value="3" id="q4a3" >
              <input type="radio" name="que_4" value="4" id="q4a4" >
              <input type="radio" name="que_4" value="5" id="q4a5" >
            </div>
          </div>
        </div>
        <div class="quesWrap__ques--each">
          ...
          <div class="quesWrap__ques--each__block">
            ...
            <div class="quesWrap__ques--each__block--value">
              <div class="quesWrap__ques--each__block--value--val">
                <label for="q5a1" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value1">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style=" opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
                ...
                <label for="q5a2" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value2">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style=" opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
                ...
                <label for="q5a3" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value3">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style="opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
                ...
                <label for="q5a4" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value4">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style="opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
                ...
                <label for="q5a5" class="quesWrap__ques--each__block--value--val--each">
                  <div class="valueBtn-value valueBtn-value5">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 512 512" style="opacity: 1;" xml:space="preserve">
                      <g>
                        <path class="st0" d="M95.438,198.203H24.313C10.891,198.203,0,209.078,0,222.516v254.438c0,13.406,10.891,24.297,24.313,24.297
              ...
              <input type="radio" name="que_5" value="1" id="q5a1" >
              <input type="radio" name="que_5" value="2" id="q5a2" >
              <input type="radio" name="que_5" value="3" id="q5a3" >
              <input type="radio" name="que_5" value="4" id="q5a4" >
              <input type="radio" name="que_5" value="5" id="q5a5" >
            </div>
          </div>
        </div>
        <div class="quesWrap__ques--each">
        ...
        <div class="quesWrap__ques--each">
          ...
          <div class="quesWrap__ques--each__block">
            <div class="quesWrap__ques--each__block--ques">
              ...
              <textarea class="input-type1" name="comment" id=""></textarea>
            </div>
          </div>
        </div>
